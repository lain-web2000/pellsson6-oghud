...
_draw_pm_row_10:
		...
		inc $07
		jsr draw_prepared_row
		row_render_data $2100, pm_star_row
		rts

_draw_pm_row_11:
		row_render_data $2120, pm_restart_row
		rts

_draw_pm_row_12:
		row_render_data $2140, pm_save_row
		rts

_draw_pm_row_13:
		row_render_data $2160, pm_load_row
		rts
...
_draw_pm_row_14:
		...
		inc $07
		jsr draw_prepared_row
		row_render_data $2180, pm_title_row
		rts

_draw_pm_row_15:
		row_render_data $21A0, pm_intro_row
		rts

_draw_pm_row_16:
		row_render_data $21C0, pm_empty_row
		rts
