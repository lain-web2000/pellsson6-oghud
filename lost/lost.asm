...
WriteBottomStatusLine:
      ...
      sta VRAM_Buffer1+2,x
      jsr GetWorldNumber  ;first the world number
      sta VRAM_Buffer1+3,x
...
CheckPlayerName:
             lda $0753     ;check selected player
...
AwardGameTimerPoints:
         ...
         ora GameTimerDisplay+1
         ora GameTimerDisplay+2
         beq NextStarFlagControl   ;if no time left on game timer at all, branch to next task
AwardTimerCastle:
         lda FrameCounter
